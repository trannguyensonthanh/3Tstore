...
function ModalProduct({show, onCancel, handleAddProduct, form, handleFinish, handleFinishFail, categories, dataButton, checkDisabled }){
  return (
    <Modal
      open={show}
      title="Add Product"
      ...
      >
        ...
        <Row>
          ...
          <Form.Item
            ...
            >
              <InputNumber disabled={checkDisabled} style={{ width: "100%" }} placeholder="Nhập số lượng sản phẩm nhập kho" min={1} />
            </Form.Item>
          </Col>
        ...
        <Row gutter={16}>
          <Col span={12}>
            ...
            >
              <InputNumber style={{ width: "100%" }} placeholder="Nhập số lượng sản phẩm" min={0} defaultValue={0} />
            </Form.Item>
          </Col>
          <Col span={12}>
            <Form.Item
